...
import LoadingOverlay from "../components/LoadingOverlay"; // import do overlay
...
export default function Imports() {
  ...
  const isAnyLoading = loadingTools || loadingEmployees; // para o overlay
  ...
  if (userRole !== "Dev") return null; // garante proteção
  ...
  return (
    <div className="font-display flex flex-col min-h-screen bg-neutral-100 relative">
      ...
      {/* Overlay de loading */}
      <LoadingOverlay show={isAnyLoading} />
